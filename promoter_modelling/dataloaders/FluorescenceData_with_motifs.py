...
class FluorescenceDataset(Dataset):
    def __init__(self, df, split_name, num_cells, cell_names, cache_dir, use_cache, num_motifs):
        super().__init__()
...
class FluorescenceDataLoader(L.LightningDataModule):    
    ...
    def __init__(self, \
        ...
        self.train_dataset = FluorescenceDataset(self.train_set, "train", self.num_cells, self.cell_names, \
                                                 cache_dir=self.cache_dir, use_cache=use_cache, num_motifs=self.num_motifs)
